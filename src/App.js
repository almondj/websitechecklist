    ...
    return (
      <React.Fragment>
        ...
        <footer className={classes.footer}>
          <p>React built in 2022. Questions or comments? Please <a className="anchor" href="mailto:feedback@websitelaunchchecklist.net" target="_blank" rel="noopener noreferrer">send your feedback!</a></p>
        </footer>
      </React.Fragment>
    );
  }
